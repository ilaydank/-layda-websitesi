...
<head>
    ...
    <title>İlayda Nur Koçak</title>
    <link rel="stylesheet" href="deneme2/style2.css">
   ...
   <div class="sayfa">
        ...
        <div class="tab">
               <button class="tablinks" onclick="openCity(event, 'anasayfa')" id="defaultOpen">anasayfa</button>
                <button class="tablinks" onclick="openCity(event, 'hakkimda')">hakkımda</button>
                <button class="tablinks" onclick="openCity(event, 'egitim')">eğitim</button>
                <button class="tablinks" onclick="openCity(event, 'projeler')">projeler</button>
                <button class="tablinks" onclick="openCity(event, 'iletisim')">iletişim</button>
        </div>
              
              
              
    <div class="logo">
        <a href="https://www.instagram.com/ilaydank/" class="fa fa-instagram"></a>
        <a href="https://twitter.com/ilaydank" class="fa fa-twitter"></a>
        <a href="https://www.linkedin.com/in/ilayda-nur-ko%C3%A7ak-60bb46153/" class="fa fa-linkedin"></a>
    </div>
</div>
    <div class="sag">
        <div class="sagSag">
        ...
        <div class="sagSol">
            <div id="anasayfa" class="tabcontent">
              ...
              <div id="egitim" class="tabcontent">
                
                <p>c</p>
              </div>
              <div id="projeler" class="tabcontent">
...
<script src="deneme2/son_ekle.js"></script>
